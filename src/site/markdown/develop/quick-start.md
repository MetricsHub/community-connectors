...
- add a test class for your connector, `src/it/java/org/metricshub/connector/it/<ConnectorId>IT.java`, that extends `AbstractConnectorReplayIT` and passes `"<ConnectorId>"` to its constructor
