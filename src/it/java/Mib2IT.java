...
public class Mib2IT {
	...
	private static final Path SNMP_WALK_DUMP_DIRECTORY =
			Paths.get("src/it/resources/snmp/mib2/snmp_walk_dump/out.walk");
	...
	void test() throws Exception {
		...
		telemetryManager.setEmulationModeSnmpInputDirectory(SNMP_WALK_DUMP_DIRECTORY.toString());
